...
t_struct = [];%final result store here
for genderID = 1:1:2
    for peopleID = 1:1:5
            ...
            for paragraphID = 1:1:10
                ...
                %       this is the real thing!
                        ...
                        while 1
                            ...
                            if strcmp(textStr{4},'"t+i"')||strcmp(textStr{4},'"t+a"')||strcmp(textStr{4},'"t+e"')...
                                    ||strcmp(textStr{4},'"t+o"')||strcmp(textStr{4},'"t+u"')
